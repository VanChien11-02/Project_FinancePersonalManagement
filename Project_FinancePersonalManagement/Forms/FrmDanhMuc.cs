...
namespace Project_FinancePersonalManagement
{
    public partial class FrmDanhMuc : Form
    {
        ...
        {
            var frmMenu = Application.OpenForms.OfType<FrmMainMenu>().FirstOrDefault();
            frmMenu?.RefreshMenu();

            var frmTK = Application.OpenForms.OfType<FrmTaiKhoan>().FirstOrDefault();
            frmTK?.RefreshTaiKhoan();

            var frmThongKe = Application.OpenForms.OfType<FrmThongKe>().FirstOrDefault();
            frmThongKe?.RefreshThongKe();

            var frmGD = Application.OpenForms.OfType<FrmGiaoDich>().FirstOrDefault();
