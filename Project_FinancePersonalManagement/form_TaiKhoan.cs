...
namespace Project_FinancePersonalManagement
{
    public partial class form_TaiKhoan : Form
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            ...
            // ==========================================
            // THÊM MỚI: Bắt lỗi nếu chọn Bank/E-Wallet mà không nhập tên
            // ==========================================
            if ((loaiTK == "Bank" || loaiTK == "E-Wallet") && string.IsNullOrEmpty(nganHang))
            {
                MessageBox.Show("Vui lòng nhập Tên Ngân hàng hoặc Ví điện tử (VD: Vietcombank, Momo...)!", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_TenNH.Focus();
                return;
            }
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            ...
            // ==========================================
            // THÊM MỚI (BÊN NÚT SỬA): Bắt lỗi nếu chọn Bank/E-Wallet mà không nhập tên
            // ==========================================
            if ((loaiTK == "Bank" || loaiTK == "E-Wallet") && string.IsNullOrEmpty(nganHang))
            {
                MessageBox.Show("Vui lòng nhập Tên Ngân hàng hoặc Ví điện tử (VD: Vietcombank, Momo...)!", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            using (DB_SystemDataContext db = new DB_SystemDataContext())
            {
                try
                {
                    ...
                    if (accToUpdate != null)
                    {
                        ...
                        accToUpdate.BankDetail = (loaiTK == "Cash" || loaiTK == "Creadit Card") ? null : nganHang;
        ...
        private void clearInputFields()
        {
            ...
            // Mở khoá lại cho ô nhập số dư
            txt_SoDu.Enabled = true;

            // Bật lại nút Thêm
            btn_Them.Enabled = true;

            // Xóa bỏ ID tài khoản đang được chọn (rất quan trọng)
